...
extern uint16_t color_bkg;
extern uint16_t color_title;
extern uint16_t color_brush;
extern uint16_t color_sensor;
extern uint16_t color_value;
extern uint16_t color_time;
