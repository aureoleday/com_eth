...
//            SR = 0x07; /* DP83848, REG16[2:1], Speed Indication. */
...
void rd_phy(uint16_t reg_addr)
{
    uint16_t sts;
    sts = ETH_ReadPHYRegister(1,reg_addr);
    rt_kprintf("DP83845 status:0x%04X\r\n", sts);
}

#ifdef RT_USING_FINSH
#include <finsh.h>
FINSH_FUNCTION_EXPORT(rd_phy, read phy reg);
#endif
